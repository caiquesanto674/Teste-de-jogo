...
class AuthManager:
    ...
    def __init__(self):
        ...
        self.admin_users = {"Caíque": "Comandante Supremo/Supreme Commander"}
    ...
    def is_admin(self, character: 'Character') -> bool:
        return character.name in self.admin_users and self.admin_users[character.name] == character.role